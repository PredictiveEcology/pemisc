#' Create cluster on BorealCloud
#'
#'
#' @param ipStart Boreal Cloud IP address that is identical across machines
#' @param ipEnd the part of IP adresses unique to each machine
#' @param availableCores the available cores on each machine
#' @param availableRAM the available RAM on each machine
#' @param nProcess the number of processes
#' @param baseProcess DESCRIPTION NEEDED
#' @param internalProcesses DESCRIPTION NEEDED
#' @param sizeGbEachProcess the size in Gb of each process
#' @param module DESCRIPTION NEEDED
...
#'
#' @export
makeIpsForClustersBoreaCloud <- function(ipStart = "10.20.0.",
...
#' make IPs
#'
#' @param ipStart DESCRIPTION NEEDED
#' @param NP DESCRIPTION NEEDED
#' @param proc DESCRIPTION NEEDED
#' @param nProcess DESCRIPTION NEEDED
#' @param sizeGbEachProcess DESCRIPTION NEEDED
#'
#' @return
#' DESCRIPTION NEEDED
#'
